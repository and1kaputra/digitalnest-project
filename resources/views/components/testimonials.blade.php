        ...
        <div class="testi-carousel" data-flickity>
            ...
            <div
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <p class="leading-[26px]">{{$review->review}}</p>
                </div>
                <div class="flex gap-[14px] items-center">
                    <div class="w-12 h-12 flex shrink-0 rounded-full overflow-hidden">
                        <img src="{{Storage::url($review->reviewer->avatar)}}" class="w-full h-full object-cover"
                            alt="photo">
                    </div>
                    <div class="flex flex-col justify-center-center">
                        ...
                        <p class="font-semibold text-left text-xs text-digitalnest-grey">{{$review->reviewer->occupation}}
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex gap-[14px] items-center">
                        ...
                        <div class="flex flex-col justify-center-center">
                            <p
                                class="font-semibold text-left leading-[170%] bg-clip-text text-transparent bg-gradient-to-r from-[#B05CB0] to-[#FCB16B]">
                                Sarah Lopez</p>
                            <p class="font-semibold text-left text-xs text-digitalnest-grey">Brand Design Consultant
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex gap-[14px] items-center">
                        ...
                        <div class="flex flex-col justify-center-center">
                            <p
                                class="font-semibold text-left leading-[170%] bg-clip-text text-transparent bg-gradient-to-r from-[#B05CB0] to-[#FCB16B]">
                                Michael Chen</p>
                            <p class="font-semibold text-left text-xs text-digitalnest-grey">UI/UX Designer</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex gap-[14px] items-center">
                        ...
                        <div class="flex flex-col justify-center-center">
                            <p
                                class="font-semibold text-left leading-[170%] bg-clip-text text-transparent bg-gradient-to-r from-[#B05CB0] to-[#FCB16B]">
                                Emily Robinson</p>
                            <p class="font-semibold text-left text-xs text-digitalnest-grey">Senior Graphic Designer
                            </p>
                        </div>
                    </div>
                </div>
