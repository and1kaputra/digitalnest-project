            ...
            <div class="flex justify-between">
                ...
                <div class="flex gap-[72px]">
                    ...
                    <div class="flex flex-col gap-8">
                        ...
                        <div class="flex flex-col gap-[18px]">
                            {{-- <a href="" class="text-digitalnest-grey font-semibold text-xs">All-Access Pass</a> --}}
                            {{-- <a href="" class="text-digitalnest-grey font-semibold text-xs">Become an author</a> --}}
                            {{-- <a href="" class="text-digitalnest-grey font-semibold text-xs">Affiliate program</a>
                            <a href="" class="text-digitalnest-grey font-semibold text-xs">Terms & Licensing</a> --}}
                        </div>
                    </div>
                    <div class="flex flex-col gap-8">
                        {{-- <p class="font-semibold text-sm">Customer service</p>
                        <div class="flex flex-col gap-[18px]">
                            <a href="" class="text-digitalnest-grey font-semibold text-xs">FAQ</a>
                            <a href="" class="text-digitalnest-grey font-semibold text-xs">Orders</a>
                            <a href="" class="text-digitalnest-grey font-semibold text-xs">Payments</a>
                            <a href="" class="text-digitalnest-grey font-semibold text-xs">refunds</a> --}}
                        {{-- </div> --}}
                    </div>
                    <div class="flex flex-col gap-8">
                        {{-- <p class="font-semibold text-sm">Contact us</p>
                        <div class="flex flex-col gap-[18px]">
                            <a href="" class="text-digitalnest-grey font-semibold text-xs">About us</a> --}}
                            {{-- <a href="" class="text-digitalnest-grey font-semibold text-xs">Company</a>
