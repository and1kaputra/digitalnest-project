...
<header class="w-full pt-[74px] pb-[103px] relative z-0">
        ...
        <div class="w-full h-1/3 absolute bottom-0 bg-gradient-to-b from-digitalnest-black/0 to-digitalnest-black z-0"></div>
        <div class="w-full h-full absolute top-0 bg-digitalnest-black/95 z-0"></div>
    </header>
            ...
            <div class="flex gap-8 relative -mt-[93px]">
                <div
                    ...
                    <div class="flex flex-row flex-wrap gap-4 items-center">
                        ...
                        <a href=""
                            class="tags p-[4px_8px] border border-[#414141] rounded-[4px] h-fit w-fit text-xs text-digitalnest-light-grey hover:bg-[#2A2A2A] transition-all duration-300">finance</a>
                        <a href=""
                            class="tags p-[4px_8px] border border-[#414141] rounded-[4px] h-fit w-fit text-xs text-digitalnest-light-grey hover:bg-[#2A2A2A] transition-all duration-300">mobile</a>
                        <a href=""
                            class="tags p-[4px_8px] border border-[#414141] rounded-[4px] h-fit w-fit text-xs text-digitalnest-light-grey hover:bg-[#2A2A2A] transition-all duration-300">money</a>
                        <a href=""
                            class="tags p-[4px_8px] border border-[#414141] rounded-[4px] h-fit w-fit text-xs text-digitalnest-light-grey hover:bg-[#2A2A2A] transition-all duration-300">personal</a>
                        <a href=""
                            class="tags p-[4px_8px] border border-[#414141] rounded-[4px] h-fit w-fit text-xs text-digitalnest-light-grey hover:bg-[#2A2A2A] transition-all duration-300">scan</a>
                        <a href=""
                            class="tags p-[4px_8px] border border-[#414141] rounded-[4px] h-fit w-fit text-xs text-digitalnest-light-grey hover:bg-[#2A2A2A] transition-all duration-300">template</a>
                        <a href=""
                            class="tags p-[4px_8px] border border-[#414141] rounded-[4px] h-fit w-fit text-xs text-digitalnest-light-grey hover:bg-[#2A2A2A] transition-all duration-300">transfer</a>
                        <a href=""
                            class="tags p-[4px_8px] border border-[#414141] rounded-[4px] h-fit w-fit text-xs text-digitalnest-light-grey hover:bg-[#2A2A2A] transition-all duration-300">ui
                            kit</a>
                        <a href=""
                            class="tags p-[4px_8px] border border-[#414141] rounded-[4px] h-fit w-fit text-xs text-digitalnest-light-grey hover:bg-[#2A2A2A] transition-all duration-300">UX</a>
                        <a href=""
                            ...
                            <div class="flex flex-col gap-3">
                                ...
                                <div class="flex flex-col gap-[10px]">
                                    <div class="flex items-center gap-[10px]">
                                        ...
                                        <p class="text-digitalnest-grey">100% Original Content</p>
                                    </div>
                                    <div class="flex items-center gap-[10px]">
                                        <div class="w-4 h-4 flex shrink-0">
                                            <img src="{{asset('/images/icons/check.svg')}}" alt="icon">
                                        </div>
                                        <p class="text-digitalnest-grey">Lifetime Support</p>
                                    </div>
                                    <div class="flex items-center gap-[10px]">
                                        <div class="w-4 h-4 flex shrink-0">
                                            <img src="{{asset('/images/icons/check.svg')}}" alt="icon">
                ...
                <div class="product-card flex flex-col rounded-[18px] bg-[#181818] overflow-hidden">
                    ...
                    <div class="p-[10px_14px_12px] h-full flex flex-col justify-between gap-[14px]">
                        <div class="flex flex-col gap-1">
                            <a href="{{route('front.details', $product->slug)}}" class="font-semibold line-clamp-2 hover:line-clamp-none">
                                {{$product->name}}</a>
                            <p
